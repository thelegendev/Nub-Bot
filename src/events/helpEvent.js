    ...
    if (interaction.customId === 'selecthelp') {
        ...
        interaction.values.forEach(async (value) => {
            ...
            if (value === 'commands') {
                ...
                .addFields({ name: `<:icon4:1100728456448323595> /invites`, value: `<:icon3:1100724523281694781> Shows a user's invite count within the server.` })
                ...
                .addFields({ name: `<:icon4:1100728456448323595> /warnings`, value: `<:icon3:1100724523281694781> Shows a user's warnings within the server.` })
                .setThumbnail(client.user.displayAvatarURL({ dynamic: true }))
                ...
                .addFields({ name: `<:icon4:1100728456448323595> /ban`, value: `<:icon3:1100724523281694781> Ban a user from the server.` })
                .addFields({ name: `<:icon4:1100728456448323595> /clear-warn`, value: `<:icon3:1100724523281694781> Clear a user's warnings.` })
                .addFields({ name: `<:icon4:1100728456448323595> /kick`, value: `<:icon3:1100724523281694781> Kick a user from the server.` })
                ...
                .addFields({ name: `<:icon4:1100728456448323595> /mod-name`, value: `<:icon3:1100724523281694781> Moderate a user's nickname.` })
                .addFields({ name: `<:icon4:1100728456448323595> /mute`, value: `<:icon3:1100724523281694781> Time out a user within the server.` })
                .addFields({ name: `<:icon4:1100728456448323595> /purge`, value: `<:icon3:1100724523281694781> Clear messages from a user.` })
                .addFields({ name: `<:icon4:1100728456448323595> /role`, value: `<:icon3:1100724523281694781> Configure roles within the server.` })
                .addFields({ name: `<:icon4:1100728456448323595> /unban`, value: `<:icon3:1100724523281694781> Unban a user in the server.` })
                .addFields({ name: `<:icon4:1100728456448323595> /unlock`, value: `<:icon3:1100724523281694781> Unlock the specified channel.` })
                .addFields({ name: `<:icon4:1100728456448323595> /unmute`, value: `<:icon3:1100724523281694781> Untime out a user within the server.` })
                .addFields({ name: `<:icon4:1100728456448323595> /verify`, value: `<:icon3:1100724523281694781> Configure the verification system.` })
                .addFields({ name: `<:icon4:1100728456448323595> /warn`, value: `<:icon3:1100724523281694781> Warn a user within the server.` })
                .setThumbnail(client.user.displayAvatarURL({ dynamic: true }))
                ...
                .addFields({ name: `<:icon4:1100728456448323595> /bonk`, value: `<:icon3:1100724523281694781> Bonk a user.` })
                ...
                .addFields({ name: `<:icon4:1100728456448323595> /impersonate`, value: `<:icon3:1100724523281694781> Impersonate a user with a webhook.` })
                ...
                .addFields({ name: `<:icon4:1100728456448323595> /user-info`, value: `<:icon3:1100724523281694781> Receive information regarding a user in the server.` })
                .setThumbnail(client.user.displayAvatarURL({ dynamic: true }))
